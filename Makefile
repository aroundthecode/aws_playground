...
docker_push:
	...
	@docker tag fntlnz/caturday:latest ${AWS_ACCOUNT}.dkr.ecr.${AWS_DEFAULT_REGION}.amazonaws.com/mikesac:latest
	@docker push ${AWS_ACCOUNT}.dkr.ecr.${AWS_DEFAULT_REGION}.amazonaws.com/mikesac:latest 